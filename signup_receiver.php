...
<div class="row gy-4" >
                        ...
                        <div class="form-group form-input">
                        <input name="city"  type="text"  placeholder="Your Blood Type"  class="form-control" required>
                        </div>
...
$sql="INSERT INTO  receiver (name,email,blood_type,usercode,phno,password) VALUES(:fname,:email,:mobile,:rollno,:phno,:password)";
